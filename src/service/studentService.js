    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    enitity_1.Student.create({ name: name }).then(function (student) {
...
function getStudents() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    enitity_1.Student.findAll().then(function (result) {
                        resolve(result);
                    });
                })];
        });
...
function getStudentbyId(id) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    enitity_1.Student.findById(id).then(function (result) {
                        resolve(result);
                    });
                })];
        });
